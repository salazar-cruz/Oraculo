const TRANSLATIONS = {
  pt: {
    ...
    "tradition.africanFigure": "Mestre Kamba",
    "tradition.africanName": "Tradição Africana",
    "tradition.africanDescription": "Ancestralidade, terra, memória, comunidade e continuidade.",
    "tradition.africanAlt": "Mestre Kamba envolvido em símbolos ancestrais da Tradição Africana",
    "tradition.europeanFigure": "Mestra Samara",
    "tradition.europeanName": "Tradição Cigana",
    "tradition.europeanDescription": "Caravanas, presságios, luar, caminhos errantes, ornamentos e intuição.",
    "tradition.europeanAlt": "Mestra Samara rodeada por símbolos místicos da Tradição Cigana",
    "tradition.elvenFigure": "Mestra Nyméria",
    "tradition.elvenName": "Tradição Élfica",
    "tradition.elvenDescription": "Florestas antigas, estrelas, rios, luas e memória da natureza.",
    "tradition.elvenAlt": "Mestra Nyméria entre símbolos florestais e estelares da Tradição Élfica",
    "tradition.ancientFigure": "Mestra Morgana",
    "tradition.ancientName": "Tradição Antiga",
    "tradition.ancientDescription": "Selos, metais, portais, bibliotecas ocultas e sabedoria primordial.",
    "tradition.ancientAlt": "Mestra Morgana diante de selos e portais da Tradição Antiga",
    "tradition.islamicFigure": "Mestre Tarik",
    "tradition.islamicName": "Tradição Islâmica",
    "tradition.islamicDescription": "Geometria, astronomia, equilíbrio, conhecimento e contemplação.",
    "tradition.islamicAlt": "Mestre Tarik entre geometria e astronomia da Tradição Islâmica",
    "tradition.buddhistFigure": "Mestre Tara",
    "tradition.buddhistName": "Tradição Budista",
    "tradition.buddhistDescription": "Compaixão, atenção, impermanência, equilíbrio e caminho interior.",
    "tradition.buddhistAlt": "Mestre Tara entre lótus e mandalas da Tradição Budista",
    ...
    "tradition.result.africana": "Mestre Kamba — Tradição Africana",
    "tradition.result.europeia": "Mestra Samara — Tradição Cigana",
    "tradition.result.elfica": "Mestra Nyméria — Tradição Élfica",
    "tradition.result.antiga": "Mestra Morgana — Tradição Antiga",
    "tradition.result.islamica": "Mestre Tarik — Tradição Islâmica",
    "tradition.result.budista": "Mestre Tara — Tradição Budista",
    ...
    "footer.concept": "DevNexus Digital",
    "footer.version": "Versão 1.7.5",
  ...
  en: {
    ...
    "tradition.africanFigure": "Master Kamba",
    "tradition.africanName": "African Tradition",
    "tradition.africanDescription": "Ancestry, earth, memory, community and continuity.",
    "tradition.africanAlt": "Master Kamba surrounded by ancestral symbols of the African Tradition",
    "tradition.europeanFigure": "Mistress Samara",
    "tradition.europeanName": "Gypsy Tradition",
    "tradition.europeanDescription": "Caravans, omens, moonlight, wandering paths, ornaments and intuition.",
    "tradition.europeanAlt": "Mistress Samara surrounded by mystical symbols of the Gypsy Tradition",
    "tradition.elvenFigure": "Mistress Nymeria",
    "tradition.elvenName": "Elven Tradition",
    "tradition.elvenDescription": "Ancient forests, stars, rivers, moons and nature's memory.",
    "tradition.elvenAlt": "Mistress Nymeria among forest and stellar symbols of the Elven Tradition",
    "tradition.ancientFigure": "Mistress Morgana",
    "tradition.ancientName": "Ancient Tradition",
    "tradition.ancientDescription": "Seals, metals, portals, hidden libraries and primordial wisdom.",
    "tradition.ancientAlt": "Mistress Morgana before seals and portals of the Ancient Tradition",
    "tradition.islamicFigure": "Master Tarik",
    "tradition.islamicName": "Islamic Tradition",
    "tradition.islamicDescription": "Geometry, astronomy, balance, knowledge and contemplation.",
    "tradition.islamicAlt": "Master Tarik among geometry and astronomy of the Islamic Tradition",
    "tradition.buddhistFigure": "Master Tara",
    "tradition.buddhistName": "Buddhist Tradition",
    "tradition.buddhistDescription": "Compassion, mindfulness, impermanence, balance and the inner path.",
    "tradition.buddhistAlt": "Master Tara among lotuses and mandalas of the Buddhist Tradition",
    ...
    "tradition.result.africana": "Master Kamba — African Tradition",
    "tradition.result.europeia": "Mistress Samara — Gypsy Tradition",
    "tradition.result.elfica": "Mistress Nymeria — Elven Tradition",
    "tradition.result.antiga": "Mistress Morgana — Ancient Tradition",
    "tradition.result.islamica": "Master Tarik — Islamic Tradition",
    "tradition.result.budista": "Master Tara — Buddhist Tradition",
  ...
  fr: {
    ...
    "tradition.africanFigure": "Maître Kamba",
    "tradition.africanName": "Tradition Africaine",
    "tradition.africanDescription": "Ancêtres, terre, mémoire, communauté et continuité.",
    "tradition.africanAlt": "Maître Kamba entouré de symboles ancestraux de la Tradition Africaine",
    "tradition.europeanFigure": "Maîtresse Samara",
    "tradition.europeanName": "Tradition Tzigane",
    "tradition.europeanDescription": "Caravanes, présages, clair de lune, routes errantes, ornements et intuition.",
    "tradition.europeanAlt": "Maîtresse Samara entourée de symboles mystiques de la Tradition Tzigane",
    "tradition.elvenFigure": "Maîtresse Nyméria",
    "tradition.elvenName": "Tradition Elfique",
    "tradition.elvenDescription": "Forêts anciennes, étoiles, rivières, lunes et mémoire de la nature.",
    "tradition.elvenAlt": "Maîtresse Nyméria parmi les symboles forestiers et stellaires de la Tradition Elfique",
    "tradition.ancientFigure": "Maîtresse Morgana",
    "tradition.ancientName": "Tradition Ancienne",
    "tradition.ancientDescription": "Sceaux, métaux, portails, bibliothèques cachées et sagesse primordiale.",
    "tradition.ancientAlt": "Maîtresse Morgana devant les sceaux et portails de la Tradition Ancienne",
    "tradition.islamicFigure": "Maître Tarik",
    "tradition.islamicName": "Tradition Islamique",
    "tradition.islamicDescription": "Géométrie, astronomie, équilibre, connaissance et contemplation.",
    "tradition.islamicAlt": "Maître Tarik parmi la géométrie et l’astronomie de la Tradition Islamique",
    "tradition.buddhistFigure": "Maître Tara",
    "tradition.buddhistName": "Tradition Bouddhiste",
    "tradition.buddhistDescription": "Compassion, attention, impermanence, équilibre et chemin intérieur.",
    "tradition.buddhistAlt": "Maître Tara parmi les lotus et mandalas de la Tradition Bouddhiste",
    ...
    "tradition.result.africana": "Maître Kamba — Tradition Africaine",
    "tradition.result.europeia": "Maîtresse Samara — Tradition Tzigane",
    "tradition.result.elfica": "Maîtresse Nyméria — Tradition Elfique",
    "tradition.result.antiga": "Maîtresse Morgana — Tradition Ancienne",
    "tradition.result.islamica": "Maître Tarik — Tradition Islamique",
    "tradition.result.budista": "Maître Tara — Tradition Bouddhiste",
