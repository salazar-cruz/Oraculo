const TRANSLATIONS = {
  pt: {
    ...
    "tradition.europeanFigure": "Mestre Cagliostro",
    "tradition.europeanName": "Tradição Europeia",
    "tradition.europeanDescription": "Quiromancia clássica, alquimia, escolhas, carácter e ciclos.",
    "tradition.europeanAlt": "Mestre Cagliostro rodeado por símbolos alquímicos da Tradição Europeia",
    "tradition.elvenFigure": "Mestre Elorand",
    "tradition.elvenName": "Tradição Élfica",
    "tradition.elvenDescription": "Florestas antigas, estrelas, rios, luas e memória da natureza.",
    "tradition.elvenAlt": "Mestre Elorand entre símbolos florestais e estelares da Tradição Élfica",
    "tradition.ancientFigure": "Mestre Malakor",
    ...
    "tradition.ancientAlt": "Mestre Malakor diante de selos e portais da Tradição Antiga",
    "tradition.islamicFigure": "Mestre Hikma",
    ...
    "tradition.islamicAlt": "Mestre Hikma entre geometria e astronomia da Tradição Islâmica",
    ...
    "tradition.result.europeia": "Mestre Cagliostro — Tradição Europeia",
    "tradition.result.elfica": "Mestre Elorand — Tradição Élfica",
    "tradition.result.antiga": "Mestre Malakor — Tradição Antiga",
    "tradition.result.islamica": "Mestre Hikma — Tradição Islâmica",
  ...
  en: {
    ...
    "tradition.europeanFigure": "Master Cagliostro",
    "tradition.europeanName": "European Tradition",
    "tradition.europeanDescription": "Classical palmistry, alchemy, choices, character and cycles.",
    "tradition.europeanAlt": "Master Cagliostro surrounded by alchemical symbols of the European Tradition",
    "tradition.elvenFigure": "Master Elorand",
    "tradition.elvenName": "Elven Tradition",
    "tradition.elvenDescription": "Ancient forests, stars, rivers, moons and nature's memory.",
    "tradition.elvenAlt": "Master Elorand among forest and stellar symbols of the Elven Tradition",
    "tradition.ancientFigure": "Master Malakor",
    ...
    "tradition.ancientAlt": "Master Malakor before seals and portals of the Ancient Tradition",
    "tradition.islamicFigure": "Master Hikma",
    ...
    "tradition.islamicAlt": "Master Hikma among geometry and astronomy of the Islamic Tradition",
    ...
    "tradition.result.europeia": "Master Cagliostro — European Tradition",
    "tradition.result.elfica": "Master Elorand — Elven Tradition",
    "tradition.result.antiga": "Master Malakor — Ancient Tradition",
    "tradition.result.islamica": "Master Hikma — Islamic Tradition",
  ...
  fr: {
    ...
    "tradition.europeanFigure": "Maître Cagliostro",
    "tradition.europeanName": "Tradition Européenne",
    "tradition.europeanDescription": "Chiromancie classique, alchimie, choix, caractère et cycles.",
    "tradition.europeanAlt": "Maître Cagliostro entouré de symboles alchimiques de la Tradition Européenne",
    "tradition.elvenFigure": "Maître Elorand",
    ...
    "tradition.elvenAlt": "Maître Elorand parmi les symboles forestiers et stellaires de la Tradition Elfique",
    "tradition.ancientFigure": "Maître Malakor",
    ...
    "tradition.ancientAlt": "Maître Malakor devant les sceaux et portails de la Tradition Ancienne",
    "tradition.islamicFigure": "Maître Hikma",
    ...
    "tradition.islamicAlt": "Maître Hikma parmi la géométrie et l’astronomie de la Tradition Islamique",
    ...
    "tradition.result.europeia": "Maître Cagliostro — Tradition Européenne",
    "tradition.result.elfica": "Maître Elorand — Tradition Elfique",
    "tradition.result.antiga": "Maître Malakor — Tradition Ancienne",
    "tradition.result.islamica": "Maître Hikma — Tradition Islamique",
